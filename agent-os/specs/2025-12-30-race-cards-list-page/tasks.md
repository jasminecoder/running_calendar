...
- [x] 1.0 Complete configuration and setup layer
  - [x] 1.1 Write 2-4 focused tests for Spanish locale date formatting
  ...
  - [x] 1.2 Create Spanish locale file for date formatting
...
- [x] 2.0 Complete backend controller layer
  - [x] 2.1 Write 3-5 focused tests for PagesController#home
  ...
  - [x] 2.2 Update PagesController#home action
...
- [x] 3.0 Complete page layout and structural components
  - [x] 3.1 Write 3-5 focused system tests for layout components
  ...
  - [x] 3.2 Update application layout for race cards page
  ...
  - [x] 3.3 Create navbar partial (`app/views/shared/_navbar.html.erb`)
  ...
  - [x] 3.4 Create Stimulus controller for hamburger menu toggle
    - Create `app/javascript/controllers/menu_controller.js`
    - Toggle menu visibility on hamburger click
    - Add smooth open/close animation
  - [x] 3.5 Create hero section partial (`app/views/shared/_hero.html.erb`)
  ...
  - [x] 3.6 Create footer partial (`app/views/shared/_footer.html.erb`)
  ...
  - [x] 3.7 Create placeholder pages to prevent 404 errors
  ...
  - [x] 3.8 Render partials in application layout or home view
    - Include navbar at top of body
    - Include footer after main content
  - [x] 3.9 Ensure layout component tests pass
...
- [x] 4.0 Complete race cards and list display
  - [x] 4.1 Write 4-6 focused system tests for race cards
  ...
  - [x] 4.2 Create placeholder image for races without featured_image
    - Create `app/assets/images/placeholder-race.jpg`
    - Simple placeholder with mxcorre branding or generic race image
  - [x] 4.3 Create race card partial (`app/views/races/_race_card.html.erb`)
  ...
  - [x] 4.9 Implement responsive grid layout
